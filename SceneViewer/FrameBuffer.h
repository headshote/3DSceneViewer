...
namespace framebuffers
{
	...
	public:
		...
		void renderColorBufferToQuad(GLuint postProcessingShader, GLuint blurShader, GLuint renderingQuad);
	...
	protected:
		...
		virtual void renderToQuad(GLuint postProcessingShader, GLuint blurShader, GLuint renderingQuad) = 0;
